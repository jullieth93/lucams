...
**Próximo del carril código:** seguir P1 (blindaje CI: E2E/axe/visual en CI + E2E de compra pagada real; luego diferenciadores 3D + IA) → P2 (backoffice: SupportTicket UI, WarrantyClaim, razones de auditoría; DR: backups R2; DIAN: InvoiceProvider tras elección de proveedor). Ver artifact ruta-produccion + journal de la auditoría en subagents/workflows/wf_e7682d03-569.
