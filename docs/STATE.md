...
**Próximo del carril código (secuencia restante):** **DIAN InvoiceProvider** (adapter + flujo; el provider real espera decisión de Lucy con contador — carril humano) → refinar nevera 3D (más realista, "a futuro"). E2E de compra pagada real (Wompi sandbox) sigue pendiente por fragilidad de red. Ver artifact ruta-produccion + journal en subagents/workflows/wf_e7682d03-569.
