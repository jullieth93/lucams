...
- **⏭️ PRÓXIMO AUTÓNOMO (plan maestro):** SLOs cuantitativos, anti-abuso COD (parcial: rate-limit COD ya existe), E2E sandboxes, Lighthouse.
- **Deuda de pruebas GUI (Lucy, navegador):** descarga producción + ZIP en /admin/pedidos, grid por-slot en /admin/moderacion, selector de año, lazy-mount, **calendario 3D**. (Conciliación COD ✅ validada.)
