...
| Lienzo de foto _(actual)_  | PHOTO_PACK                                 | `photoSlots`                      | N fotos, 1 por imán                | el editor de hoy tal cual. **Línea base.**                     |
...
| img.ly CE.SDK                                   | no            | ~US$13k/año (Vendr, _pendiente_) | Descartar: motor distinto + caro.                                                                                                                                                                             |
...
- **A) Acentos en nombres del abecedario** (José, María) — _la más urgente para evitar "pedí mal"_. Rec: ✅
