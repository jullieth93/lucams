...
- **Migración Free→Pro:** Vercel Pro · Supabase Pro (PITR 7 días) · Resend Pro · compra dominio `lucamsshop.com` en mi.com.co · DNS Cloudflare · dominio→Vercel · DNS email `mail.lucamsshop.com` (SPF/DKIM/DMARC) · Wompi prod · Venndelo prod · cambio número WhatsApp.
...
- **Criterios:** compra real con tarjeta real procesa · cliente recibe email desde `hola@mail.lucamsshop.com` · envío llega vía Coordinadora/Venndelo · sin errores 500 en Vercel Logs durante 24h · Lighthouse ≥95 en críticas.
...
- **El "día 1" real está definido por la Fase 7** (criterios de aceptación líneas 489-495): compra real con tarjeta real OK · email desde `hola@mail.lucamsshop.com` · envío llega vía Coordinadora/Venndelo · cero errores 500 en 24h continuas · Lighthouse ≥95 en todas las páginas críticas.
