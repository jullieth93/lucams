...
| **E** | Testing (RLS, E2E, visual, a11y) | transversal / Fase 7 | 🟡 En curso (R3 matriz RLS + 368 unit tests; 467 total. Falta: CI-DB/Supabase-local, E2E Playwright, visual, a11y, load) |
