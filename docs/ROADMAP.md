...
| **E** | Testing (RLS, E2E, visual, a11y) | transversal / Fase 7 | 🟡 En curso (R3 matriz RLS + 700 unit/integration tests con revisión adversarial; **805 total**. Falta: CI-DB/Supabase-local, E2E Playwright, visual, a11y, load) |
