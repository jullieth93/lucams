...
Agrupamos las cookies en cuatro categorías, las mismas que ves en el banner de consentimiento cuando llegas al sitio:

- **Necesarias** — Hacen que el sitio funcione: inicio de sesión, carrito, checkout, seguridad y anti-bot. Siempre están activas porque son indispensables para prestarte el servicio; sin ellas no podrías comprar.
- **Funcionales** — Recuerdan tus preferencias (por ejemplo, idioma o vista del catálogo). _Opcionales._
- **Analíticas** — Métricas anónimas y agregadas para entender qué funciona y qué no. _Opcionales._
- **Marketing** — Recomendaciones y campañas relevantes. _Opcionales._

Las tres categorías opcionales están **desactivadas por defecto** y solo se activan si tú las aceptas. Tu autorización es **previa, expresa e informada**, y queda registrada para nuestra trazabilidad (art. 9 de la Ley 1581).

> Hoy solo usamos cookies **necesarias**. Todavía no tenemos cookies funcionales, analíticas ni de marketing activas. Si algún día las activamos, aparecerán en la tabla de abajo y solo se cargarán con tu consentimiento.
...
Tú mandas. Puedes decidir en cualquier momento:

- **En el banner** que aparece en tu primera visita: _Solo necesarias_, _Personalizar_ (para elegir categoría por categoría) o _Aceptar todas_.
- **Cuando quieras**, con el botón **"Abrir preferencias"** (al final de esta página y en el pie del sitio) para cambiar o **revocar** tu elección.
- **Desde tu navegador**, borrando o bloqueando cookies en la configuración. Ten en cuenta que si bloqueas las **necesarias**, es probable que no puedas iniciar sesión ni completar tu compra.

Cambiar tus preferencias o revocar tu consentimiento no tiene ningún costo y no afecta la validez del tratamiento que hicimos antes de que revocaras (art. 8 de la Ley 1581).

## Tus derechos

Como titular de tus datos puedes conocer, actualizar, rectificar y suprimir tu información, pedir prueba de la autorización que nos diste y revocarla. Atendemos tus **consultas** en máximo **10 días hábiles** y tus **reclamos** en máximo **15 días hábiles** (arts. 14 y 15 de la Ley 1581). También puedes acudir a la **Superintendencia de Industria y Comercio (SIC)**. Todo el detalle está en el **Aviso de Privacidad** y en **Hábeas Data**.
