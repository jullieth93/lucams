...
También publicamos la información de contacto en formato legible por máquina en [/.well-known/security.txt](/.well-known/security.txt) (RFC 9116).
...
Tratamos los datos personales conforme a nuestra [Política de Privacidad](/legal/privacidad) y a la Ley 1581 de 2012 (Habeas Data), y ante un incidente que comprometa datos personales notificamos a la Superintendencia de Industria y Comercio (SIC) según corresponde.
...
El archivo legible por máquina con nuestra información de contacto de seguridad está disponible en [/.well-known/security.txt](/.well-known/security.txt), siguiendo el estándar [RFC 9116](https://www.rfc-editor.org/rfc/rfc9116).
