...
const REPLACEMENTS = [
  [/\bEmpezá\b/g, "Empieza"], [/\bempezá\b/g, "empieza"],
  [/\bElegí\b/g, "Elige"], [/\belegí\b/g, "elige"],
  [/\bEligí\b/g, "Elige"], [/\beligí\b/g, "elige"],
  [/\bProbá\b/g, "Prueba"], [/\bprobá\b/g, "prueba"],
  [/\bMandá\b/g, "Manda"], [/\bmandá\b/g, "manda"],
  [/\bDecidí\b/g, "Decide"], [/\bdecidí\b/g, "decide"],
  [/\bPersonalizá\b/g, "Personaliza"], [/\bpersonalizá\b/g, "personaliza"],
  [/\bHacé\b/g, "Haz"], [/\bhacé\b/g, "haz"],
  ...
  [/\bTomá\b/g, "Toma"], [/\btomá\b/g, "toma"],
  [/\bEscribí\b/g, "Escribe"], [/\bescribí\b/g, "escribe"],
  [/\bescribinos\b/g, "escríbenos"], [/\bEscribinos\b/g, "Escríbenos"],
  [/\bComentá\b/g, "Comenta"], [/\bcomentá\b/g, "comenta"],
  [/\bEscogé\b/g, "Escoge"], [/\bescogé\b/g, "escoge"],
  [/\bComprá\b/g, "Compra"], [/\bcomprá\b/g, "compra"],
  [/\bCompartí\b/g, "Comparte"], [/\bcompartí\b/g, "comparte"],
  [/\bSeguí\b/g, "Sigue"], [/\bseguí\b/g, "sigue"],
  [/\bOlvidá\b/g, "Olvida"], [/\bolvidá\b/g, "olvida"],
  [/\bFijate\b/g, "Fíjate"], [/\bfijate\b/g, "fíjate"],
  [/\bMirá\b/g, "Mira"], [/\bmirá\b/g, "mira"],
  [/\bLlevá\b/g, "Lleva"], [/\bllevá\b/g, "lleva"],
  [/\bUsá\b/g, "Usa"], [/\busá\b/g, "usa"],
  [/\bAyudá\b/g, "Ayuda"], [/\bayudá\b/g, "ayuda"],
  [/\bayudanos\b/g, "ayúdanos"], [/\bAyudanos\b/g, "Ayúdanos"],
  [/\bLlamá\b/g, "Llama"], [/\bllamá\b/g, "llama"],
  [/\bGuardá\b/g, "Guarda"], [/\bguardá\b/g, "guarda"],
  [/\bCargá\b/g, "Carga"], [/\bcargá\b/g, "carga"],
  [/\bSubí\b/g, "Sube"], [/\bsubí\b/g, "sube"],
  [/\bRecordá\b/g, "Recuerda"], [/\brecordá\b/g, "recuerda"],
  [/\bLeé\b/g, "Lee"], [/\bleé\b/g, "lee"],
  [/\bencontrás\b/g, "encuentras"], [/\bEncontrás\b/g, "Encuentras"],
  [/\bbuscás\b/g, "buscas"], [/\bBuscás\b/g, "Buscas"],
  [/\bIntentá\b/g, "Intenta"], [/\bintentá\b/g, "intenta"],
  [/\bRecargá\b/g, "Recarga"], [/\brecargá\b/g, "recarga"],
  [/\bCreá\b/g, "Crea"], [/\bcreá\b/g, "crea"],
  [/\bnecesitás\b/g, "necesitas"], [/\bNecesitás\b/g, "Necesitas"],
  [/\bTocá\b/g, "Toca"], [/\btocá\b/g, "toca"],
  [/\bSumá\b/g, "Suma"], [/\bsumá\b/g, "suma"],
  [/\bAtendé\b/g, "Atiende"], [/\batendé\b/g, "atiende"],
  [/\bVolvé\b/g, "Vuelve"], [/\bvolvé\b/g, "vuelve"],
  [/\bPedí\b/g, "Pide"], [/\bpedí\b/g, "pide"],
  [/\bcontá\b/g, "cuenta"], [/\bContá\b/g, "Cuenta"],
  [/\bEditá\b/g, "Edita"], [/\beditá\b/g, "edita"],
  [/\bRevisá\b/g, "Revisa"], [/\brevisá\b/g, "revisa"],
  [/\bAplicá\b/g, "Aplica"], [/\baplicá\b/g, "aplica"],
  [/\bConfirmá\b/g, "Confirma"], [/\bconfirmá\b/g, "confirma"],
  [/\bIngresá\b/g, "Ingresa"], [/\bingresá\b/g, "ingresa"],
  [/\bAgregá\b/g, "Agrega"], [/\bagregá\b/g, "agrega"],
  [/\bArrastrá\b/g, "Arrastra"], [/\barrastrá\b/g, "arrastra"],
  [/\bDejá\b/g, "Deja"], [/\bdejá\b/g, "deja"],
  [/\bAceptá\b/g, "Acepta"], [/\baceptá\b/g, "acepta"],
  [/\bAvisá\b/g, "Avisa"], [/\bavisá\b/g, "avisa"],
  [/\bCambiá\b/g, "Cambia"], [/\bcambiá\b/g, "cambia"],
  [/\bSeleccioná\b/g, "Selecciona"], [/\bseleccioná\b/g, "selecciona"],
  [/\bDescargá\b/g, "Descarga"], [/\bdescargá\b/g, "descarga"],
  [/\baceptás\b/g, "aceptas"], [/\bAceptás\b/g, "Aceptas"],
  [/\bDecí\b/g, "Di"], [/\bdecí\b/g, "di"],
];
...
async function main() {
  ...
  console.log(`Product.description: ${productsUpdated} actualizados / ${products.length} revisados`);
  ...
  console.log(`OcasionTag.description: ${ocasionesUpdated} actualizados / ${ocasiones.length} revisados`);
