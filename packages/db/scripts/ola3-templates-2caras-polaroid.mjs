...
const TEMPLATES = [
  ...
  },
  {
    ...
    canvasData: {
      ...
      layers: [
        { id: "background", type: "background", color: "#FFFFFF" },
        { id: "p1", type: "image-placeholder", x: 29, y: 58, width: 392, height: 392, label: "Tu foto" },
        { id: "frame", type: "asset", src: "/templates/ig_post_3x4.svg", x: 0, y: 0, width: 450, height: 600, rotation: 0, opacity: 1 },
        { id: "user_name", type: "text", x: 68, y: 28, text: "@tu_usuario", fontFamily: "Inter", fontSize: 16, fill: "#262626", fontWeight: "bold", align: "left", editable: true },
        { id: "location", type: "text", x: 68, y: 46, text: "Bogotá, Colombia", fontFamily: "Inter", fontSize: 12, fill: "#8E8E8E", align: "left", editable: true },
        { id: "likes_count", type: "text", x: 22, y: 486, text: "362 me gusta", fontFamily: "Inter", fontSize: 15, fill: "#262626", fontWeight: "bold", align: "left", editable: true },
        { id: "caption", type: "text", x: 22, y: 502, text: "Tu título acá", fontFamily: "Inter", fontSize: 16, fill: "#262626", fontWeight: "bold", align: "left", editable: true },
        { id: "hashtags", type: "text", x: 22, y: 518, text: "#mirecuerdo #lucamsshop", fontFamily: "Inter", fontSize: 13, fill: "#00376B", fontWeight: "normal", align: "left", editable: true },
      ],
    },
  },
  ...(separadoresProduct
