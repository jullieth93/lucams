...
const settings = [
  // CONTACT
  { key: "CONTACT_EMAIL", value: "hola@lucamsshop.co", valueType: "EMAIL", label: "Email de contacto público", description: "Aparece en footer, páginas legales y formulario de contacto.", category: "CONTACT" },
  { key: "SECURITY_EMAIL", value: "security@lucamsshop.co", valueType: "EMAIL", label: "Email de seguridad", description: "Para reportes de vulnerabilidad. Aparece en /legal/security.", category: "CONTACT" },

  // BUSINESS
  { key: "BUSINESS_HOURS", value: "Lun-Sáb 9am – 7pm COT", valueType: "TEXT", label: "Horario de atención", description: "Aparece en footer columna 'Atención cliente'.", category: "BUSINESS" },
  { key: "BUSINESS_LOCATION", value: "Bogotá, Colombia", valueType: "TEXT", label: "Ubicación del negocio", description: "Aparece en /legal/privacidad.", category: "BUSINESS" },

  // SOCIAL
  { key: "SOCIAL_INSTAGRAM_URL", value: "https://www.instagram.com/lucams_shop", valueType: "URL", label: "Instagram URL", description: "Link del ícono Instagram en el footer.", category: "SOCIAL" },
  { key: "SOCIAL_TIKTOK_URL", value: "https://www.tiktok.com/@lucams_shop", valueType: "URL", label: "TikTok URL", description: "Link del ícono TikTok en el footer.", category: "SOCIAL" },

  // LEGAL
  { key: "RETRACTION_DAYS_BUSINESS", value: "5", valueType: "NUMBER", label: "Días hábiles de retracto (Ley 1480)", description: "Plazo para retractarse según Ley 1480 art. 47. Aparece en /legal/terminos y /legal/devoluciones.", category: "LEGAL" },
  { key: "WARRANTY_DURATION_YEARS", value: "1", valueType: "NUMBER", label: "Años de garantía legal (Ley 1480)", description: "Duración de la garantía legal según Ley 1480 art. 11.", category: "LEGAL" },
  { key: "HABEAS_DATA_CONSULTATION_DAYS", value: "10", valueType: "NUMBER", label: "Días para responder consulta hábeas data", description: "Plazo Ley 1581 para responder consulta.", category: "LEGAL" },
  { key: "HABEAS_DATA_CLAIM_DAYS", value: "15", valueType: "NUMBER", label: "Días para responder reclamo hábeas data", description: "Plazo Ley 1581 para responder reclamo.", category: "LEGAL" },
  { key: "PRIVACY_POLICY_VERSION", value: "v1 · 2026-05-12", valueType: "TEXT", label: "Versión actual del Aviso de Privacidad", description: "Se muestra al titular cuando da consentimiento.", category: "LEGAL" },

  // COMMERCE
  { key: "MANUFACTURING_DAYS_RANGE", value: "5-7 días hábiles", valueType: "TEXT", label: "Tiempo de fabricación", description: "Tiempo que tardan los productos personalizados en fabricarse antes de envío.", category: "COMMERCE" },
  { key: "DELIVERY_COVERAGE_COUNT", value: "1.100+", valueType: "TEXT", label: "Cobertura de envío (destinos)", description: "Aparece en hero, /legal/subprocesadores y home.", category: "COMMERCE" },

  // EXTERNAL — DPA links
  { key: "DPA_SUPABASE_URL", value: "https://supabase.com/legal/dpa", valueType: "URL", label: "DPA Supabase", description: "Acuerdo de tratamiento de datos. Aparece en /legal/subprocesadores.", category: "EXTERNAL" },
  { key: "DPA_VERCEL_URL", value: "https://vercel.com/legal/dpa", valueType: "URL", label: "DPA Vercel", category: "EXTERNAL" },
  { key: "DPA_RESEND_URL", value: "https://resend.com/legal/dpa", valueType: "URL", label: "DPA Resend", category: "EXTERNAL" },
  { key: "DPA_WOMPI_URL", value: "https://wompi.com/legal", valueType: "URL", label: "DPA Wompi", category: "EXTERNAL" },
  { key: "DPA_VENNDELO_URL", value: "https://venndelo.com/legal", valueType: "URL", label: "DPA Venndelo / Coordinadora", category: "EXTERNAL" },
  { key: "DPA_CLOUDFLARE_URL", value: "https://www.cloudflare.com/cloudflare-customer-dpa/", valueType: "URL", label: "DPA Cloudflare", category: "EXTERNAL" },
  { key: "DPA_ANTHROPIC_URL", value: "https://www.anthropic.com/legal/dpa", valueType: "URL", label: "DPA Anthropic", category: "EXTERNAL" },
  { key: "GOVT_SIC_URL", value: "https://www.sic.gov.co", valueType: "URL", label: "URL de la SIC (gobierno)", description: "Aparece en /legal/habeas-data para reclamos.", category: "EXTERNAL" },

  // WHATSAPP — Plantillas de mensajes pre-armados
  { key: "WA_MSG_PRODUCT", value: 'Hola Lucams 👋 Quiero saber más sobre "{productName}" (SKU {sku}).', valueType: "TEXT", label: "Mensaje WhatsApp — Consulta sobre producto", description: 'Plantilla cuando el cliente hace click en "Consultar por WhatsApp" desde un producto. Variables: {productName} {sku}.', category: "WHATSAPP" },
  { key: "WA_MSG_PERSONALIZE", value: 'Hola Lucams 👋 Quiero personalizar "{productName}" (SKU {sku}). Te paso fotos y referencias por aquí ✨', valueType: "TEXT", label: "Mensaje WhatsApp — Personalizar producto", description: "Plantilla del botón 'Personalizar' en producto. Variables: {productName} {sku}.", category: "WHATSAPP" },
  { key: "WA_MSG_SUPPORT", value: "Hola Lucams 👋 Tengo una consulta y quería hablar por aquí.", valueType: "TEXT", label: "Mensaje WhatsApp — Soporte general", description: "Plantilla del botón WhatsApp del header/footer cuando NO hay asunto específico.", category: "WHATSAPP" },
  { key: "WA_MSG_SUPPORT_SUBJECT", value: "Hola Lucams 👋 Tengo una consulta sobre: {subject}", valueType: "TEXT", label: "Mensaje WhatsApp — Soporte con asunto", description: "Plantilla cuando hay un tema específico. Variable: {subject}.", category: "WHATSAPP" },
  { key: "WA_MSG_ORDER", value: "Hola Lucams 👋 Quiero consultar el estado de mi pedido {orderNumber}.", valueType: "TEXT", label: "Mensaje WhatsApp — Consulta de pedido", description: "Variable: {orderNumber}.", category: "WHATSAPP" },
  { key: "WA_MSG_WHOLESALE", value: "Hola Lucams 👋 Estoy interesado/a en pedido al por mayor / corporativo. ¿Me puedes contar?", valueType: "TEXT", label: "Mensaje WhatsApp — Pedido al por mayor", category: "WHATSAPP" },

  // COPYRIGHT
  { key: "COPYRIGHT_YEAR", value: "2026", valueType: "NUMBER", label: "Año del copyright", description: "Aparece en el footer. Actualizar cada enero.", category: "COPYRIGHT" },
  { key: "COPYRIGHT_TAGLINE", value: "Hecho con 💜 en Bogotá", valueType: "TEXT", label: "Tagline del copyright", description: "Aparece después del © en el footer.", category: "COPYRIGHT" },
  { key: "APP_NAME", value: "Lucams_shop", valueType: "TEXT", label: "Nombre de la marca", description: "Aparece en metadata SEO y title de las páginas.", category: "COPYRIGHT" },

  // SEO
  { key: "SITE_TAGLINE", value: "Tus recuerdos en imán", valueType: "TEXT", label: "Tagline del sitio (SEO)", description: "Aparece en el title de la home: 'Lucams_shop — Tus recuerdos en imán'.", category: "SEO" },
  { key: "SITE_DESCRIPTION", value: "Imanes magnéticos personalizados, fotoimanes, recuerdos para eventos, calendarios y planners. Hechos a mano en Colombia con entrega a 1.100+ destinos.", valueType: "TEXT", label: "Meta description default", description: "Texto que Google muestra en resultados de búsqueda para la home.", category: "SEO" },
];
