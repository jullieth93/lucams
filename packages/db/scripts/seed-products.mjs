...
const productsData = [
  ...
  // ────────────────────── regalos-personalizados (5) ──────────────────────
  {
    ...
    personalizationSchema: { photoSlots: 6, allowText: true, includesNote: true },
  ...
  },
  {
    ...
    isPersonalizable: true,
    personalizationKind: "CUSTOM_DECOR",
    personalizationSchema: { photoSlots: 4, allowText: true, includesNote: true },
  ...
  },
  {
    ...
    isPersonalizable: true,
    personalizationKind: "CUSTOM_DECOR",
    personalizationSchema: { photoSlots: 6, shape: "heart", allowText: true, includesNote: true },
    images: [UNSPLASH("1518621736915-f3b1c41bfd00")],
  },
  {
  ...
  // ────────────────────── cuadros-decoracion (4) ──────────────────────
  {
    ...
    isPersonalizable: true,
    personalizationKind: "CUSTOM_DECOR",
    personalizationSchema: { photoSlots: 1, sizeCm: "15×15", allowText: true },
