 ...
 *
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/backfill-category-visuals.mjs
 */
...
assertDestructiveAllowed("backfill-category-visuals.mjs");
