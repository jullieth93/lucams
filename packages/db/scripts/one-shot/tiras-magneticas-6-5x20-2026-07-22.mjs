 ...
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/tiras-magneticas-6-5x20-2026-07-22.mjs
 */
...
assertDestructiveAllowed("tiras-magneticas-6-5x20-2026-07-22.mjs");
