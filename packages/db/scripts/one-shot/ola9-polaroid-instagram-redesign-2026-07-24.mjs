 ...
 *
 * Uso:  pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola9-polaroid-instagram-redesign-2026-07-24.mjs
 */
...
assertDestructiveAllowed("ola9-polaroid-instagram-redesign-2026-07-24.mjs");
