 ...
 *
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/apply-tira-template-2026-07-22.mjs
 */
...
assertDestructiveAllowed("apply-tira-template-2026-07-22.mjs");
