 ...
 * QuoteItem.variantId es SetNull. (2026-09-12: StockReservation ya no existe
 * en el schema — N-10.)
 *
 * Uso:
 *   node scripts/one-shot/cleanup-legacy-paused-variants.mjs            # DRY-RUN
 *   node scripts/one-shot/cleanup-legacy-paused-variants.mjs --apply    # ejecuta
 *   node scripts/one-shot/cleanup-legacy-paused-variants.mjs --apply --also-archived
