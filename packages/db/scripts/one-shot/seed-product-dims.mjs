 ...
 *
 * Uso:
 *   node packages/db/scripts/one-shot/seed-product-dims.mjs
 *   (antes tenía el target `make seed-product-dims`, retirado al archivarlo — N-06)
 */
...
assertDestructiveAllowed("seed-product-dims.mjs");
