 ...
 *
 * Uso: pnpm --filter @lucams/db exec node scripts/one-shot/consolidate-product-families.mjs
 *      (su target `make consolidate-product-families` se retiró al archivarlo — N-06)
 */
...
assertDestructiveAllowed("consolidate-product-families.mjs");
 ...
 * Auto-generated by packages/db/scripts/one-shot/consolidate-product-families.mjs
 ...
 * NO editar a mano. Re-generar con:
 *   pnpm --filter @lucams/db exec node scripts/one-shot/consolidate-product-families.mjs
 */
