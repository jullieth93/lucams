 ...
 *
 * Uso:
 *   node scripts/one-shot/update-delivery-copy-20260801.mjs           # dry-run (default)
 *   node scripts/one-shot/update-delivery-copy-20260801.mjs --apply   # aplica
 * Con dotenv según ambiente (desde packages/db):
 *   npx dotenv -e ../../.env.local -- node scripts/one-shot/update-delivery-copy-20260801.mjs --apply
 *   npx dotenv -e ../../.env.stg   -- node scripts/one-shot/update-delivery-copy-20260801.mjs --apply
 *
...
assertDestructiveAllowed("update-delivery-copy-20260801.mjs");
