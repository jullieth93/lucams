 ...
 *
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola17-separadores-alargados.mjs
 */
...
assertDestructiveAllowed("ola17-separadores-alargados.mjs");
