 ...
 *
 * Patrón tomado del viejo scripts/seed-reviews-demo.mjs (borrado en N-06, 2026-09-12): customerId:null + authorName/authorCity
 ...
 *
 * Uso:
 *   node scripts/one-shot/seed-reviews-circle.mjs
 */
