 ...
 * Transacción única. Uso: pnpm --filter @lucams/db exec node scripts/one-shot/polaroid-qty-libre-2026-07-22.mjs
 */
...
assertDestructiveAllowed("polaroid-qty-libre-2026-07-22.mjs");
