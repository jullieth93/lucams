 ...
 * Transaccional. Uso:
 *   pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/fotoimanes-cuadrados-8x8-10x10-2026-07-22.mjs
 */
...
assertDestructiveAllowed("fotoimanes-cuadrados-8x8-10x10-2026-07-22.mjs");
