 ...
 *
 * Idempotente. Uso:
 *   pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola4-depura-plantillas-2026-07-23.mjs
 */
...
assertDestructiveAllowed("ola4-depura-plantillas-2026-07-23.mjs");
