 ...
 *
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola18b-cuadrados-tiras-fix.mjs
 */
...
assertDestructiveAllowed("ola18b-cuadrados-tiras-fix.mjs");
