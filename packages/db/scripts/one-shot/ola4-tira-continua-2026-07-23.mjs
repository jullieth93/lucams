 ...
 *
 * Uso:  pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola4-tira-continua-2026-07-23.mjs
 */
...
assertDestructiveAllowed("ola4-tira-continua-2026-07-23.mjs");
