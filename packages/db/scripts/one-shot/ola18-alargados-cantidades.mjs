 ...
 *
 * Uso: pnpm --filter @lucams/db exec dotenv -e ../../.env.local -- node scripts/one-shot/ola18-alargados-cantidades.mjs
 */
...
assertDestructiveAllowed("ola18-alargados-cantidades.mjs");
