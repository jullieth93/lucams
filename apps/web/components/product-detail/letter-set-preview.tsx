/*
 * ADR-057 — "Esto recibes" para productos que SON un set de letras (Abecedario Completo,
 * Pack Vocales). Muestra la biblioteca de fichas (una fuente de verdad) directo en la
 * ficha; si una letra aún no tiene dibujo, muestra un placeholder. Server component.
 */
...
export function LetterSetPreview({
  ...
  return (
    <section className="mt-10">
      ...
      {subtitle && <p className="text-brand-muted mt-1 mb-4 text-sm">{subtitle}</p>}
