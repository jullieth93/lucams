...
<p>Gracias por escribirnos. Tu ticket es <strong style="font-family:monospace;background:#FFF8F0;padding:2px 6px;border-radius:4px;">#${ticketShort}</strong> y te vamos a responder <strong>por correo</strong> (a esta misma dirección) en menos de <strong>24 horas hábiles</strong>.</p>
...
Gracias por escribirnos. Tu ticket es #${ticketShort} y te respondemos por correo (a esta misma dirección) en menos de 24 horas hábiles.
...
El equipo de Lucams_shop`;
  ...
  return {
    ...
    html: await renderEmailLayout({
      preview: `Ticket #${ticketShort} registrado. Te respondemos por correo en menos de 24h.`,
      bodyHtml,
    }),
    text,
  };
