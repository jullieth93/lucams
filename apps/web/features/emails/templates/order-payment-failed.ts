...
<p style="margin-top:16px;"><strong>¿Qué podés hacer?</strong></p>
<ul style="padding-left:20px;margin:8px 0;">
  <li>Volvé al carrito y reintentá con la misma tarjeta</li>
  <li>Probá con otro medio de pago (PSE, Nequi, Bancolombia)</li>
  <li>Verificá con tu banco si bloquearon la compra</li>
</ul>

${ctaButton(`${siteUrl}/carrito`, "Volver al carrito →")}

<p style="font-size:13px;color:#3D2E5C;opacity:0.65;margin-top:18px;">No te cobramos nada. Tu carrito sigue ahí esperándote. Si seguís con dudas, respondé este email o escribinos por WhatsApp.</p>
`;
...
¿Qué podés hacer?
- Volvé al carrito y reintentá con la misma tarjeta
- Probá con otro medio de pago (PSE, Nequi, Bancolombia)
- Verificá con tu banco si bloquearon la compra
...
No te cobramos nada. Tu carrito sigue ahí esperándote.`;
  ...
  return {
    ...
    html: await renderEmailLayout({
      preview: `${friendlyReason} · reintentá con otro medio`,
      bodyHtml,
    }),
    text,
  };
