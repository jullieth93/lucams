 ...
 *
 * PLACEHOLDERS NO IMPRIMIBLES (regla global, Ola 23 2026-09-08): los textos por
 * defecto de esta plantilla ("@tu_usuario", "Bogotá, Colombia", "362 me gusta",
 * "Tu título acá", "#mirecuerdo #lucamsshop") son capas `editable: true` — en el
 * Estudio se ven ATENUADOS (guía de lo que el cliente puede escribir) pero NUNCA
 * se hornean en el PNG de producción: solo se imprime el texto que el cliente
 * escribió explícitamente (TextOverride). Misma regla en el render server-side
 * (production-render-canvas) y en el snapshot del cliente (edit-indicator).
 */
