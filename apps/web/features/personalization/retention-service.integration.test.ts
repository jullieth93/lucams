 ...
 * para no tocar datos reales ni de otras corridas. Los tests de filtro NO usan assets → corren en CI
 * (solo Prisma). Los tests que borran bytes van gated por SUPABASE_SECRET_KEY (Storage real).
 */
...
describe.skipIf(!process.env.DATABASE_URL)("retención — purga de diseños anónimos", () => {
